...
####タスク1：シミュレートされたデバイスプロジェクトをビルドして実行する
...
1. **sensor-thl-2000**ブレードで、[**Device Twin**]をクリックします。
...
###演習5：グループ登録から1台のデバイスのプロビジョニングを解除する
...
1. [**登録の管理**]ペインで、[**個別の登録を追加する**]をクリックします。
...
1. [**Add Enrollment**]ブレードの[**IoT Hub Device ID**]で、「**sensor-thl-2004**」と入力します
...
1. [**登録グループの詳細**]ブレードで、下にスクロールして[**エントリを有効にする**]フィールドを見つけ、[**無効にする**]をクリックします。
