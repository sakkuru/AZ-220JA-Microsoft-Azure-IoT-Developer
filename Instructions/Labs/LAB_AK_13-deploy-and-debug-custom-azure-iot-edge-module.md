...
1. ポリシーのリストで、iothubownerをクリックします。

    重要： Edge Simulatorには、構成に特権ロールが必要です。通常のユースケースでは、このような特権ロールを使用することはありません。

1. iothubownerの接続文字列をコピーしておきます。
...
1. 前にメモした、**iothubownerのプライマリ接続文字列**を入力します。
